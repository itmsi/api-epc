...
const getAll = async (req, res) => {
  try {
    ...
    const data = await repository.findAll(pageNum, limitNum, search, sort_by, sort_order, normalizedCategoryId);
...
const create = async (req, res) => {
  try {
    ...
    return successResponse(res, data, 'Type Category berhasil dibuat', 201);
  } catch (error) {
    return errorResponse(res, error.message || 'Terjadi kesalahan', 500);
  }
};
...
const update = async (req, res) => {
  try {
    ...
    return successResponse(res, data, 'Type Category berhasil diupdate');
  } catch (error) {
    return errorResponse(res, error.message || 'Terjadi kesalahan', 500);
  }
};
...
const remove = async (req, res) => {
  try {
    ...
    return successResponse(res, null, 'Type Category berhasil dihapus');
  } catch (error) {
    return errorResponse(res, error.message || 'Terjadi kesalahan', 500);
  }
};
...
const restore = async (req, res) => {
  try {
    ...
    return successResponse(res, data, 'Type Category berhasil direstore');
  } catch (error) {
    return errorResponse(res, error.message || 'Terjadi kesalahan', 500);
  }
};
