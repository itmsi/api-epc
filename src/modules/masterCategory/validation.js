...
const getValidation = [
  ...
  body('sort_by')
    .optional()
    .isIn(['created_at', 'master_category_name_en', 'master_category_name_cn'])
    .withMessage('Sort by harus salah satu dari: created_at, master_category_name_en, master_category_name_cn'),
  body('sort_order')
    .optional()
    .isIn(['asc', 'desc'])
...
const createValidation = [
  ...
  body('master_category_name_cn')
    .optional()
    .isLength({ max: 255 })
    .withMessage('Master category name CN maksimal 255 karakter')
    .trim(),
  body('master_category_description')
    .optional()
    .isString()
    .withMessage('Master category description harus berupa string')
    .trim(),
];
