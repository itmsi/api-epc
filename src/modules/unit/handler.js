...
const create = async (req, res) => {
  try {
    ...
    return successResponse(res, data, 'Unit berhasil dibuat', 201);
  } catch (error) {
    return errorResponse(res, error.message || 'Terjadi kesalahan', 500);
  }
};
...
const update = async (req, res) => {
  try {
    ...
    return successResponse(res, data, 'Unit berhasil diupdate');
  } catch (error) {
    return errorResponse(res, error.message || 'Terjadi kesalahan', 500);
  }
};
...
const remove = async (req, res) => {
  try {
    ...
    return successResponse(res, null, 'Unit berhasil dihapus');
  } catch (error) {
    return errorResponse(res, error.message || 'Terjadi kesalahan', 500);
  }
};
